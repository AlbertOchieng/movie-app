...
import com.example.albertzkiki.movieapp.Adapter.TrailerAdapter;
import com.example.albertzkiki.movieapp.api.Server;
import com.example.albertzkiki.movieapp.api.client;
import com.example.albertzkiki.movieapp.model.Trailer;
...
public class DetailActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        if(intentThatStartedThatActivity.hasExtra("original_title")){
    ...
    public void intCollapsingToolBar(){
    ...
    private void loadJSON(){
        ...
        try{
            ...
            Call<TrailerResponse> call = apiServer.getMovieTrailer(movie_id, BuildConfig.THE_MOVIE_DB_API_TOKEN);
